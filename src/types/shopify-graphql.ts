...
export const useAddToCartMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
    AddToCartMutation,
    TError,
...
export const useRemoveFromCartMutation = <TError = unknown, TContext = unknown>(
  options?: UseMutationOptions<
...
export const GetCustomerOrdersDocument = `
    query getCustomerOrders($customerAccessToken: String!, $first: Int!, $after: String, $sortKey: OrderSortKeys, $reverse: Boolean) {
